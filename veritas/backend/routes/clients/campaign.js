...
router.get('/all-campaigns', requireAnyPermission('cybersecurite.view', 'clients.view'), async (req, res) => {
  try {
...
router.get('/:id/campaigns', requireAnyPermission('cybersecurite.view', 'clients.view'), async (req, res) => {
  try {
    const {
      id
    } = req.params;
...
router.post('/:id/campaigns', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      id
    } = req.params;
...
router.put('/:id/campaigns/:campaignId', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.delete('/campaigns/:campaignId', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      campaignId
    } = req.params;
...
router.delete('/:id/campaigns/:campaignId', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.post('/:id/campaigns/:campaignId/launch', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.post('/:id/campaigns/:campaignId/pause', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.post('/:id/campaigns/:campaignId/resume', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.post('/:id/campaigns/:campaignId/finish', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.post('/:id/campaigns/:campaignId/reset', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.get('/:id/campaigns/:campaignId/stats', requireAnyPermission('cybersecurite.view', 'clients.view'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.get('/:id/campaigns/:campaignId/report.pdf', requireAnyPermission('cybersecurite.view', 'clients.view'), async (req, res) => {
  try {
    const {
      id,
      campaignId
...
router.get('/:id/campaigns/:campaignId/steps', requireAnyPermission('cybersecurite.view', 'clients.view'), async (req, res) => {
  try {
    const {
      campaignId
    } = req.params;
...
router.post('/:id/campaigns/:campaignId/steps', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      campaignId
    } = req.params;
...
router.put('/:id/campaigns/:campaignId/steps/reorder', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      campaignId
    } = req.params;
...
router.put('/:id/campaigns/:campaignId/steps/:stepId', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      stepId
    } = req.params;
...
router.delete('/:id/campaigns/:campaignId/steps/:stepId', requirePermission('clients_detail.campaigns'), async (req, res) => {
  try {
    const {
      stepId
    } = req.params;
