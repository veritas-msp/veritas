...
const DETAIL_COPY = {
  fr: {
    ...
    importSites: "Importer des lieux (CSV)",
    noSites: "Aucun lieu",
  ...
  de: {
    ...
    importSites: "Standorte importieren (CSV)",
  ...
  es: {
    ...
    importSites: "Importar ubicaciones (CSV)",
