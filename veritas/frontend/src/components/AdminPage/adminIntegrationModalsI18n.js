...
const CHECKMK = {
  fr: {
    ...
    syncSuspended: "Suspendre le rafraîchissement automatique",
  ...
  en: {
    ...
    syncSuspended: "Suspend automatic refresh",
  ...
  de: {
    ...
    syncSuspended: "Automatische Aktualisierung pausieren",
  ...
  it: {
    ...
    syncSuspended: "Sospendi aggiornamento automatico",
    syncSuspendedHint: "Nessuna sync automatica. La sync manuale forzata resta disponibile.",
    surveillanceSuspended: "Sospendi la supervisione",
    surveillanceSuspendedHint: "Nasconde gli alert CheckMK nel centro di supervisione e blocca i ticket auto.",
  ...
  es: {
    ...
    syncSuspended: "Suspender la actualización automática",
    syncSuspendedHint: "Sin sync automática. La sync manual forzada sigue disponible.",
    surveillanceSuspended: "Suspender la supervisión",
    surveillanceSuspendedHint: "Oculta las alertas CheckMK del centro de supervisión y bloquea los tickets auto.",
