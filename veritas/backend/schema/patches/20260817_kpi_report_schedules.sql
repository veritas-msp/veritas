...
BEGIN
  ...
  IF to_regclass('public.v_b_kpi_report_schedules') IS NOT NULL THEN
    EXECUTE format('GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE v_b_kpi_report_schedules TO %I', app_user);
  END IF;
END $$;
