...
const FR = {
  fields: {
    ...
    vlan: "VLAN",
    vlanPlaceholder: "Ajouter un VLAN…",
    vlanHint: "Entrée ou virgule pour ajouter. Vous pouvez coller 10, 20, 30.",
    vlanRemoveAria: "Retirer le VLAN {vlan}",
    ...
    haNoServerAvailable: "Aucun serveur physique disponible",
    haSelectServer: "Sélectionner un serveur",
    haNoServerPartnerHint: "Aucun autre serveur physique sans haute disponibilité sur ce client.",
    haNoSanAvailable: "Aucun SAN disponible",
    haSelectSan: "Sélectionner un SAN",
    haNoSanPartnerHint: "Aucun autre SAN sans haute disponibilité sur ce client.",
    hypervisorPlatform: "Hyperviseur / Plateforme",
    hostServer: "Serveur hôte",
    hostServerSelect: "Sélectionner un serveur hôte",
    hostServerNoneAvailable: "Aucun serveur hôte disponible",
    hostServerHint: "Ajoutez un serveur physique avec le rôle « Hôte » pour le rattacher.",
    osSystem: "OS / Système",
...
const EN = {
  fields: {
    ...
    ipPlaceholder: "192.168.10.1",
    vlan: "VLAN",
    vlanPlaceholder: "Add a VLAN…",
    vlanHint: "Press Enter or comma to add. You can paste 10, 20, 30.",
    vlanRemoveAria: "Remove VLAN {vlan}",
    adminUrl: "Admin URL",
    ...
    haNoServerAvailable: "No physical server available",
    haSelectServer: "Select a server",
    haNoServerPartnerHint: "No other physical server without high availability on this client.",
    haNoSanAvailable: "No SAN available",
    haSelectSan: "Select a SAN",
    haNoSanPartnerHint: "No other SAN without high availability on this client.",
    hypervisorPlatform: "Hypervisor / platform",
    hostServer: "Host server",
    hostServerSelect: "Select a host server",
    hostServerNoneAvailable: "No host server available",
    hostServerHint: "Add a physical server with the “Host” role to link it.",
    osSystem: "OS / system",
...
const DE = {
  ...
  fields: {
    ...
    hostServer: "Host-Server",
    hostServerSelect: "Host-Server auswählen",
    hostServerNoneAvailable: "Kein Host-Server verfügbar",
    hostServerHint: "Fügen Sie einen physischen Server mit der Rolle „Host“ hinzu.",
    osSystem: "OS / System",
    raid: "RAID",
    quickConnect: "QuickConnect",
...
const IT = {
  ...
  fields: {
    ...
    hostServerSelect: "Seleziona un server host",
    hostServerNoneAvailable: "Nessun server host disponibile",
    hostServerHint: "Aggiungi un server fisico con il ruolo « Host » per collegarlo.",
    osSystem: "OS / sistema",
    raid: "RAID",
    quickConnect: "QuickConnect",
...
const ES = {
  ...
  fields: {
    ...
    hostServer: "Servidor host",
    hostServerSelect: "Seleccionar un servidor host",
    hostServerNoneAvailable: "Ningún servidor host disponible",
    hostServerHint: "Añade un servidor físico con el rol « Host » para vincularlo.",
    osSystem: "SO / sistema",
    raid: "RAID",
    quickConnect: "QuickConnect",
