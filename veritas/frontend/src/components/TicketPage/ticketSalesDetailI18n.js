...
const COPY = {
  fr: {
    ...
    meta: {
      ...
      followers: "Suiveur",
      status: "Statut",
      equipment: "Périphérique",
      searchEquipment: "Rechercher un périphérique…",
      clearEquipment: "Retirer le périphérique",
      selectClientFirst: "Sélectionnez d’abord une entreprise",
      loadingEquipment: "Chargement du parc…",
      noEquipmentFound: "Aucun périphérique trouvé",
      equipmentSaved: "Périphérique lié",
      equipmentCleared: "Périphérique retiré",
      none: "—",
    ...
    tasks: {
      ...
      planningLinkedHint: "Si une date est renseignée, un événement est créé ou mis à jour sur le planning.",
      planningOptionalHint: "La date est optionnelle. Sans date, la tâche reste uniquement dans le ticket.",
      markDone: "Marquer comme faite",
      markTodo: "Marquer comme à faire",
      equipment: "Périphérique",
      equipmentNone: "Aucun périphérique",
      equipmentHint: "Liez un périphérique du parc client (synchronisé avec le planning).",
      equipmentEmpty: "Aucun périphérique disponible pour cette entreprise.",
      modal: {
        eyebrow: "Tâches",
        ...
        scheduleDesc: "Créneau optionnel, synchronisé avec le planning s'il est renseigné.",
  ...
  en: {
    ...
    meta: {
      ...
      status: "Status",
      equipment: "Device",
      searchEquipment: "Search for a device…",
      clearEquipment: "Remove device",
      selectClientFirst: "Select a company first",
      loadingEquipment: "Loading fleet…",
      noEquipmentFound: "No device found",
      equipmentSaved: "Device linked",
      equipmentCleared: "Device removed",
      none: "—",
    ...
    tasks: {
      ...
      planningLinkedHint: "If a date is set, an event is created or updated on the planning.",
      planningOptionalHint: "Date is optional. Without a date, the task stays on the ticket only.",
      markDone: "Mark as done",
      markTodo: "Mark as to do",
      equipment: "Device",
      equipmentNone: "No device",
      equipmentHint: "Link a device from the client fleet (synced to planning).",
      equipmentEmpty: "No device available for this company.",
      modal: {
        eyebrow: "Tasks",
        ...
        scheduleDesc: "Optional time slot, synced with planning when set.",
  ...
  de: {
    ...
    meta: {
      ...
      status: "Status",
      equipment: "Gerät",
      searchEquipment: "Gerät suchen…",
      clearEquipment: "Gerät entfernen",
      selectClientFirst: "Zuerst ein Unternehmen wählen",
      loadingEquipment: "Flotte wird geladen…",
      noEquipmentFound: "Kein Gerät gefunden",
      equipmentSaved: "Gerät verknüpft",
      equipmentCleared: "Gerät entfernt",
      none: "—",
    ...
    tasks: {
      ...
      equipment: "Gerät",
      equipmentNone: "Kein Gerät",
      equipmentHint: "Gerät aus der Kundenflotte verknüpfen (mit Planung synchronisiert).",
      equipmentEmpty: "Kein Gerät für dieses Unternehmen verfügbar.",
      modal: {
        eyebrow: "Aufgaben",
  ...
  it: {
    ...
    meta: {
      ...
      searchEquipment: "Cerca un dispositivo…",
      clearEquipment: "Rimuovi dispositivo",
      selectClientFirst: "Seleziona prima un'azienda",
      loadingEquipment: "Caricamento del parco…",
      noEquipmentFound: "Nessun dispositivo trovato",
      equipmentSaved: "Dispositivo collegato",
      equipmentCleared: "Dispositivo rimosso",
      none: "—",
    ...
    tasks: {
      ...
      equipment: "Dispositivo",
      equipmentNone: "Nessun dispositivo",
      equipmentHint: "Collega un dispositivo del parco cliente (sincronizzato con il planning).",
      equipmentEmpty: "Nessun dispositivo disponibile per questa azienda.",
      modal: {
        eyebrow: "Attività",
  ...
  es: {
    ...
    meta: {
      ...
      status: "Estado",
      equipment: "Dispositivo",
      searchEquipment: "Buscar un dispositivo…",
      clearEquipment: "Quitar dispositivo",
      selectClientFirst: "Seleccione primero una empresa",
      loadingEquipment: "Cargando el parque…",
      noEquipmentFound: "Ningún dispositivo encontrado",
      equipmentSaved: "Dispositivo vinculado",
      equipmentCleared: "Dispositivo eliminado",
      none: "—",
    ...
    tasks: {
      ...
      equipment: "Dispositivo",
      equipmentNone: "Sin dispositivo",
      equipmentHint: "Vincule un dispositivo del parque del cliente (sincronizado con el planning).",
      equipmentEmpty: "Ningún dispositivo disponible para esta empresa.",
      modal: {
        eyebrow: "Tareas",
