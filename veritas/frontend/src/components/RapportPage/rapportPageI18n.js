  ...
  fr: {
    ...
    supervisionBuilder: {
      ...
      syncProgress: {
        ...
        running: "Un petit moment, on synchronise les intégrations.",
  ...
  en: {
    ...
    supervisionBuilder: {
      ...
      syncProgress: {
        ...
        running: "Hang tight — we're syncing the integrations.",
        ...
        hostFamilyLabel: "Monitoring · {name} ({count})",
        ...
        nddGroupLabel: "Domain names ({count})",
        familyLabels: {
          internet: "Internet",
          servers: "Servers",
          firewalls: "Firewalls",
  ...
  de: {
    ...
    supervisionBuilder: {
      ...
      syncProgress: {
        ...
        running: "Wir synchronisieren die Integrationen.",
        ...
        hostFamilyLabel: "Überwachung · {name} ({count})",
        backupJobs: "Backup · CheckMK-Jobs",
        backupJobsBatch: " ({current}/{total})",
        antivirusLabel: "Antivirus · {name}",
        antispamLabel: "Antispam · {name}",
        ...
        nddLabel: "Domain · {name}",
        nddGroupLabel: "Domainnamen ({count})",
        familyLabels: {
          internet: "Internet",
          servers: "Server",
          firewalls: "Firewalls",
  ...
  it: {
    ...
    supervisionBuilder: {
      ...
      syncProgress: {
        ...
        running: "Sincronizziamo le integrazioni.",
        ...
        hostFamilyLabel: "Supervisione · {name} ({count})",
        ...
        nddGroupLabel: "Nomi di dominio ({count})",
        familyLabels: {
          internet: "Internet",
          servers: "Server",
          firewalls: "Firewall",
  ...
  es: {
    ...
    supervisionBuilder: {
      ...
      syncProgress: {
        ...
        running: "Sincronizamos las integraciones.",
        ...
        hostFamilyLabel: "Supervisión · {name} ({count})",
        ...
        nddLabel: "Dominio · {name}",
        nddGroupLabel: "Nombres de dominio ({count})",
        familyLabels: {
          internet: "Internet",
          servers: "Servidores",
          firewalls: "Firewalls",
