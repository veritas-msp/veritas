...
const CREATE_COPY = {
  fr: {
    ...
    linkContact: "Rattacher à un contact",
    linkContactTitle: "Rattacher l'email à un contact",
    linkContactSubtitle: "Ajoute {email} aux coordonnées du contact choisi et le définit comme demandeur.",
    linkContactSearch: "Rechercher un contact…",
    linkContactEmpty: "Aucun contact trouvé",
    linkContactError: "Impossible de rattacher l'email",
    orphanRequesterMenuAria: "Options pour le demandeur",
    newContact: "Nouveau",
    ...
    subject: "Sujet",
    kbSuggestTitle: "Articles de la base de connaissances",
    kbSuggestOpen: "Ouvrir l’article",
    ...
    companyRequired: "Sélectionnez une entreprise",
    contract: "Contrat",
    options: "Options",
    credits: "Crédits",
    sla: "SLA",
    ...
    aiPriorityTitle: "Priorité automatique (IA)",
    aiPriorityOk: "Priorité IA appliquée",
    aiPriorityError: "Impossible de suggérer la priorité",
    aiPriorityNeedContent: "Renseignez un titre ou une description avant de suggérer la priorité.",
    channelLabel: "Canal",
  ...
  en: {
    ...
    linkContact: "Link to a contact",
    linkContactTitle: "Link email to a contact",
    linkContactSubtitle: "Adds {email} to the selected contact details and sets them as requester.",
    linkContactSearch: "Search a contact…",
    linkContactEmpty: "No contact found",
    linkContactError: "Unable to link the email",
    orphanRequesterMenuAria: "Requester options",
    newContact: "New",
    ...
    notePlaceholder: "Note…",
    subject: "Subject",
    kbSuggestTitle: "Knowledge base articles",
    kbSuggestOpen: "Open article",
    ...
    aiPriorityTitle: "Automatic priority (AI)",
    aiPriorityOk: "AI priority applied",
    aiPriorityError: "Unable to suggest priority",
    aiPriorityNeedContent: "Enter a title or description before suggesting priority.",
  ...
  de: {
    ...
    linkContact: "Mit Kontakt verknüpfen",
    linkContactTitle: "E-Mail mit Kontakt verknüpfen",
    linkContactSubtitle: "Fügt {email} den Kontaktdaten hinzu und setzt den Kontakt als Anforderer.",
    linkContactSearch: "Kontakt suchen…",
    linkContactEmpty: "Kein Kontakt gefunden",
    linkContactError: "E-Mail konnte nicht verknüpft werden",
    orphanRequesterMenuAria: "Anforderer-Optionen",
    newContact: "Neu",
    ...
    subject: "Betreff",
    kbSuggestTitle: "Artikel der Wissensdatenbank",
    kbSuggestOpen: "Artikel öffnen",
    ...
    aiPriorityTitle: "Automatische Priorität (KI)",
    aiPriorityOk: "KI-Priorität angewendet",
    aiPriorityError: "Priorität konnte nicht vorgeschlagen werden",
    aiPriorityNeedContent: "Geben Sie einen Titel oder eine Beschreibung ein.",
    channelLabel: "Kanal",
  ...
  it: {
    ...
    linkContact: "Collega a un contatto",
    linkContactTitle: "Collega l'email a un contatto",
    linkContactSubtitle: "Aggiunge {email} ai dettagli del contatto selezionato e lo imposta come richiedente.",
    linkContactSearch: "Cerca un contatto…",
    linkContactEmpty: "Nessun contatto trovato",
    linkContactError: "Impossibile collegare l'email",
    orphanRequesterMenuAria: "Opzioni richiedente",
    newContact: "Nuovo",
    ...
    subject: "Oggetto",
    kbSuggestTitle: "Articoli della knowledge base",
    kbSuggestOpen: "Apri articolo",
    ...
    aiPriorityTitle: "Priorità automatica (IA)",
    aiPriorityOk: "Priorità IA applicata",
    aiPriorityError: "Impossibile suggerire la priorità",
    aiPriorityNeedContent: "Inserisci un titolo o una descrizione.",
    channelLabel: "Canale",
  ...
  es: {
    ...
    linkContact: "Vincular a un contacto",
    linkContactTitle: "Vincular el email a un contacto",
    linkContactSubtitle: "Añade {email} a los datos del contacto elegido y lo define como solicitante.",
    linkContactSearch: "Buscar un contacto…",
    linkContactEmpty: "Ningún contacto encontrado",
    linkContactError: "No se pudo vincular el email",
    orphanRequesterMenuAria: "Opciones del solicitante",
    newContact: "Nuevo",
    ...
    notePlaceholder: "Nota…",
    subject: "Asunto",
    kbSuggestTitle: "Artículos de la base de conocimientos",
    kbSuggestOpen: "Abrir artículo",
    ...
    aiPriorityTitle: "Prioridad automática (IA)",
    aiPriorityOk: "Prioridad IA aplicada",
    aiPriorityError: "No se pudo sugerir la prioridad",
    aiPriorityNeedContent: "Indique un título o una descripción.",
    channelLabel: "Canal",
...
export function getTicketCreateCopy(locale) {
  ...
  return {
    ...
    formatLinkContactSubtitle: email => interpolate(t.linkContactSubtitle, {
      email: String(email || "")
    }),
