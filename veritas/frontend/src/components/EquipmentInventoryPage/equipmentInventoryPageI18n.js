...
const COPY = {
  fr: {
    ...
    searchPlaceholder: "Nom, IP, série, entreprise, type, tag…",
    ...
    filters: {
      ...
      noTagFound: "Aucun tag pour ces filtres",
      clear: "Effacer",
  ...
  en: {
    ...
    searchPlaceholder: "Name, IP, serial, company, type, tag…",
    ...
    filters: {
      ...
      noTagFound: "No tags for these filters",
      clear: "Clear",
  ...
  de: {
    ...
    searchPlaceholder: "Name, IP, Serie, Unternehmen, Typ, Tag…",
    ...
    filters: {
      ...
      noTagFound: "Keine Tags für diese Filter",
      clear: "Löschen",
  ...
  it: {
    ...
    searchPlaceholder: "Nome, IP, serie, azienda, tipo, tag…",
  ...
  es: {
    ...
    searchPlaceholder: "Nombre, IP, serie, empresa, tipo, etiqueta…",
