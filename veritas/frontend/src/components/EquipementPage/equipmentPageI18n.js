...
const PAGE_COPY = {
  fr: {
    ...
    embedded: {
      ...
      mkCriticalTitle: "Périphériques en criticité",
      mkWarningTitle: "Périphériques en warning",
      mkCriticalLabel: "Critique",
      mkWarningLabel: "Warning",
      mkSyncLabel: "Sync",
      perPage: "Par page",
  ...
  en: {
    ...
    embedded: {
      ...
      mkCriticalTitle: "Devices in critical status",
      mkWarningTitle: "Devices in warning status",
      mkCriticalLabel: "Critical",
      mkWarningLabel: "Warning",
      mkSyncLabel: "Sync",
      perPage: "Per page",
  ...
  de: {
    ...
    embedded: {
      ...
      mkCriticalTitle: "Geräte im kritischen Status",
      mkWarningTitle: "Geräte im Warning-Status",
      mkCriticalLabel: "Kritisch",
      mkWarningLabel: "Warning",
      mkSyncLabel: "Sync",
      perPage: "Pro Seite",
  ...
  it: {
    ...
    embedded: {
      ...
      mkAlertsLabel: "Alert",
      mkCriticalTitle: "Periferiche in criticità",
      mkWarningTitle: "Periferiche in warning",
      mkCriticalLabel: "Critico",
      mkWarningLabel: "Warning",
      mkSyncLabel: "Sync",
      perPage: "Per pagina",
  ...
  es: {
    ...
    embedded: {
      ...
      mkCriticalTitle: "Periféricos en criticidad",
      mkWarningTitle: "Periféricos en warning",
      mkCriticalLabel: "Crítico",
      mkWarningLabel: "Warning",
      mkSyncLabel: "Sync",
      perPage: "Por página",
