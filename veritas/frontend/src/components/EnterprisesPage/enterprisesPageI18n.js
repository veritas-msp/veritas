...
const ENTERPRISES_COPY = {
  fr: {
    ...
    onboardingTooltip: "Client en onboarding · {days} j. · encore {remaining} j.",
    onboardingTooltipToday: "Client en onboarding · créé aujourd'hui · encore {remaining} j.",
  ...
  en: {
    ...
    tagsAria: "Tags",
    onboardingBadge: "Onboarding",
    onboardingTooltip: "Client onboarding · {days} d. · {remaining} d. left",
    onboardingTooltipToday: "Client onboarding · created today · {remaining} d. left",
  ...
  de: {
    ...
    tagsAria: "Tags",
    onboardingBadge: "Onboarding",
    onboardingTooltip: "Kunde im Onboarding · {days} T. · noch {remaining} T.",
    onboardingTooltipToday: "Kunde im Onboarding · heute erstellt · noch {remaining} T.",
  ...
  it: {
    ...
    tagsAria: "Etichette",
    onboardingBadge: "Onboarding",
    onboardingTooltip: "Cliente in onboarding · {days} g. · ancora {remaining} g.",
    onboardingTooltipToday: "Cliente in onboarding · creato oggi · ancora {remaining} g.",
  ...
  es: {
    ...
    tagsAria: "Etiquetas",
    onboardingBadge: "Onboarding",
    onboardingTooltip: "Cliente en onboarding · {days} d. · quedan {remaining} d.",
    onboardingTooltipToday: "Cliente en onboarding · creado hoy · quedan {remaining} d.",
