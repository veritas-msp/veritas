...
export const ALLOWED_EMPLOYEE_RANGES = ["1-10", "11-50", "51-200", "201-500", "501-1000", "1001+"];
...
export const GENERAL_SETTINGS_LABELS = {
  ...
  [GENERAL_SETTING_KEYS.timezone]: "Time zone",
  [GENERAL_SETTING_KEYS.dateFormat]: "Date format",
  [GENERAL_SETTING_KEYS.organizationName]: "Organization name",
  [GENERAL_SETTING_KEYS.defaultTheme]: "Default theme",
  [GENERAL_SETTING_KEYS.defaultPageSize]: "Items per page (default)",
  [GENERAL_SETTING_KEYS.supportEmail]: "Support contact email",
  [GENERAL_SETTING_KEYS.supportPhone]: "Support phone",
