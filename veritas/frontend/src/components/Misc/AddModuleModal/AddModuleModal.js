      ...
      <div className={styles.panel} onClick={event => event.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="add-module-modal-title">
        ...
        <div className={styles.body}>
          {MODULE_SECTIONS.map(section => <section key={section.id} className={styles.section} aria-label={section.label}>
              ...
              const isActive = activeDocType === module.docType || module.docType === "Contrat" && activeDocType === "ContratDetail" || module.docType === "Contact" && activeDocType === "ContactDetail" || module.docType === "Prestataire" && activeDocType === "PrestataireDetail" || module.docType === "Ticket" && ["Ticket", "TicketDetail", "TicketCreate"].includes(activeDocType) || module.docType === "TicketSales" && ["TicketSales", "TicketSalesCreate", "TicketSalesDetail"].includes(activeDocType) || module.docType === "Hardware" && ["Hardware", "Equipment", "EquipmentDetail"].includes(activeDocType) || module.docType === "Cybersecurite" && ["Cybersecurite", "CampaignDetail", "AntivirusDetail", "AntispamDetail"].includes(activeDocType) || module.docType === "Service" && ["Service", "TenantDetail"].includes(activeDocType) || module.docType === "Report" && ["Report", "MonitoringDetail"].includes(activeDocType);
