...
const CONTACTS_COPY = {
  ...
  de: {
    ...
    actions: {
      ...
      callPhone: "Anrufen",
      callPhoneAria: "{phone} anrufen",
      sendEmail: "E-Mail senden",
      sendEmailAria: "E-Mail an {email} senden",
  ...
  it: {
    ...
    actions: {
      ...
      callPhone: "Chiama",
      callPhoneAria: "Chiama {phone}",
      sendEmail: "Invia email",
      sendEmailAria: "Invia email a {email}",
