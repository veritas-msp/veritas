...
const ADMIN_MAIL_COLLECT_COPY = {
  "fr": {
    ...
    "collectorPeek": {
      ...
      "notice": "Ces mails sont physiquement dans le dossier IMAP ouvert (pas un filtre webmail). Le destinataire (To) peut différer de l’adresse de connexion (alias, CC, boîte partagée).",
      "folderLabel": "Dossier",
  ...
  "en": {
    ...
    "collectorPeek": {
      ...
      "notice": "These emails are physically stored in the opened IMAP folder (not a webmail filter). The To recipient can differ from the login address (alias, CC, shared mailbox).",
      "folderLabel": "Folder",
