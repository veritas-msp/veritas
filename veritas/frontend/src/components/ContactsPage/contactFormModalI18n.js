...
const CONTACT_FORM_COPY = {
  ...
  de: {
    ...
    primaryForCompany: "Hauptkontakt für dieses Unternehmen",
  ...
  it: {
    ...
    primaryForCompany: "Principale per questa azienda",
  ...
  es: {
    ...
    addCompany: "Añadir una empresa",
    primaryForCompany: "Principal para esta empresa",
