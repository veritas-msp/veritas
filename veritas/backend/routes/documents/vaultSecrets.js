...
router.get("/", requireAnyPermission("vault.view", "clients_detail.vault"), async (req, res) => {
  try {
...
router.post("/", requireAnyPermission("vault.manage", "clients_detail.vault"), async (req, res) => {
  try {
...
router.post("/:id/revoke", requireAnyPermission("vault.manage", "clients_detail.vault"), async (req, res) => {
  try {
