...
const TAB_KEYS = ["microsoft", "domain", "ssl"];
const TAB_ICONS = {
...
const SERVICE_PAGE = {
  fr: {
    ...
    domain: {
      ...
      syncDomains: "Synchroniser les noms de domaine (toutes les intégrations)",
      priorityTitle: "À traiter en priorité",
      alertCount: "{count} alerte",
      alertCountPlural: "{count} alertes",
    ...
    toasts: {
      ...
      syncDomainsStarted: "Synchronisation des noms de domaine en cours…",
      syncDomainsError: "Erreur lors de la synchronisation des domaines",
      syncDomainsSuccess: "Synchronisation terminée avec succès",
      syncNoneMicrosoft: "Aucun tenant Microsoft à synchroniser",
      syncNoneDomains: "Aucune intégration de noms de domaine à synchroniser",
      syncProgress: "Synchronisation {current}/{total} · {name}",
      syncSuccess: "Synchronisation terminée : {success} mis à jour{errors}",
      syncSuccessErrors: ", {count} erreur(s)",
      syncFailed: "Synchronisation échouée : {count} erreur(s)",
  ...
  en: {
    ...
    domain: {
      ...
      syncDomains: "Sync domain names (all integrations)",
      priorityTitle: "Priority actions",
      alertCount: "{count} alert",
      alertCountPlural: "{count} alerts",
    ...
    toasts: {
      ...
      syncDomainsStarted: "Domain name sync in progress…",
      syncDomainsError: "Domain sync failed",
      syncDomainsSuccess: "Sync completed successfully",
      syncNoneMicrosoft: "No Microsoft tenant to sync",
      syncNoneDomains: "No domain name integration to sync",
      syncProgress: "Syncing {current}/{total} · {name}",
      syncSuccess: "Sync completed: {success} updated{errors}",
      syncSuccessErrors: ", {count} error(s)",
      syncFailed: "Sync failed: {count} error(s)",
  ...
  de: {
    ...
    domain: {
      ...
      syncDomains: "Domainnamen synchronisieren (alle Integrationen)",
      priorityTitle: "Vorrangig bearbeiten",
      alertCount: "{count} Warnung",
      alertCountPlural: "{count} Warnungen",
    ...
    toasts: {
      ...
      syncDomainsStarted: "Domainnamen-Synchronisation läuft…",
      syncDomainsError: "Domain-Synchronisation fehlgeschlagen",
      syncDomainsSuccess: "Synchronisation erfolgreich abgeschlossen",
      syncNoneMicrosoft: "Kein Microsoft-Mandant zum Synchronisieren",
      syncNoneDomains: "Keine Domain-Integration zum Synchronisieren",
      syncProgress: "Synchronisation {current}/{total} · {name}",
      syncSuccess: "Synchronisation abgeschlossen: {success} aktualisiert{errors}",
      syncSuccessErrors: ", {count} Fehler",
      syncFailed: "Synchronisation fehlgeschlagen: {count} Fehler",
  ...
  it: {
    ...
    domain: {
      ...
      syncDomains: "Sincronizza i nomi di dominio (tutte le integrazioni)",
      priorityTitle: "Da trattare in priorità",
      alertCount: "{count} avviso",
      alertCountPlural: "{count} avvisi",
    ...
    toasts: {
      ...
      syncDomainsStarted: "Sincronizzazione nomi di dominio in corso…",
      syncDomainsError: "Errore sincronizzazione domini",
      syncDomainsSuccess: "Sincronizzazione completata",
      syncNoneMicrosoft: "Nessun tenant Microsoft da sincronizzare",
      syncNoneDomains: "Nessuna integrazione di nomi di dominio da sincronizzare",
      syncProgress: "Sincronizzazione {current}/{total} · {name}",
      syncSuccess: "Sincronizzazione completata: {success} aggiornati{errors}",
      syncSuccessErrors: ", {count} errore/i",
      syncFailed: "Sincronizzazione non riuscita: {count} errore/i",
  ...
  es: {
    ...
    domain: {
      ...
      syncDomains: "Sincronizar nombres de dominio (todas las integraciones)",
      priorityTitle: "Por tratar con prioridad",
      alertCount: "{count} alerta",
      alertCountPlural: "{count} alertas",
    ...
    toasts: {
      ...
      syncDomainsStarted: "Sincronización de nombres de dominio en curso…",
      syncDomainsError: "Error al sincronizar dominios",
      syncDomainsSuccess: "Sincronización completada",
      syncNoneMicrosoft: "Ningún tenant Microsoft que sincronizar",
      syncNoneDomains: "Ninguna integración de nombres de dominio que sincronizar",
      syncProgress: "Sincronización {current}/{total} · {name}",
      syncSuccess: "Sincronización completada: {success} actualizados{errors}",
      syncSuccessErrors: ", {count} error(es)",
      syncFailed: "Sincronización fallida: {count} error(es)",
...
export function getServicePageCopy(locale) {
  ...
  return {
    ...
    formatSyncSuccess: (success, errorCount) => interpolate(t.toasts.syncSuccess, {
      success: String(success),
      errors: errorCount > 0 ? interpolate(t.toasts.syncSuccessErrors, {
        count: String(errorCount)
      }) : ""
    }),
    formatSyncFailed: count => interpolate(t.toasts.syncFailed, {
      count: String(count)
    }),
    ssl: {
      ...bind(t.ssl),
